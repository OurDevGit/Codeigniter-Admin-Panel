                ...
                <div class="panel-body">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group <?php echo form_error('fullname') ? 'has-error' : '' ?>">
                            <label class="control-label" for="inputError"><?php echo form_error('fullname'); ?></label>
                            <input class="form-control" placeholder="Enter FullName" name="fullname" type="text" value="<?php echo set_value('fullname'); ?>" autofocus>
                        </div>
